...
export function EventHero() {
  return (
    <div className='relative bg-gray-50 overflow-hidden py-24 pb-48'>
      ...
      <main className='relative mt-16 mx-auto max-w-7xl px-4 sm:mt-24 z-10'>
        <div className='text-center'>
          <h1 className='text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl'>
            ...
            <span className='block text-indigo-600 xl:inline'>Knowledge.</span>
          </h1>
      ...
      <div className='absolute bottom-0 animate-bounce w-full mt-5 mx-auto sm:flex sm:justify-center md:mt-8'>
        <HiOutlineArrowNarrowDown size={60} color='gray' />
      </div>
    </div>
  );
}
